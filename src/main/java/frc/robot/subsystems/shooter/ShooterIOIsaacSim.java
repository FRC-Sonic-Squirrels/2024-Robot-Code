...
public class ShooterIOIsaacSim implements ShooterIO {
  ...
  public void setKickerVelocity(double revPerMin) {
    dispatcher.sendMotorInfo(Constants.CanIDs.SHOOTER_KICKER_CAN_ID, Units.rotationsPerMinuteToRadiansPerSecond(revPerMin));
  }

  @Override
  public void setLauncherRPM(double topRollerRPM, double bottomRollerRPM) {
    dispatcher.sendMotorInfo(Constants.CanIDs.SHOOTER_LEAD_CAN_ID, Units.rotationsPerMinuteToRadiansPerSecond(topRollerRPM));
    dispatcher.sendMotorInfo(Constants.CanIDs.SHOOTER_FOLLOW_CAN_ID, Units.rotationsPerMinuteToRadiansPerSecond(bottomRollerRPM));
  }
}
